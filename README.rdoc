...
you are seeing the nested inside Rails (or whatever you want) version of this blog

clone into ROOT/blog

copy racked.rb to ROOT
...
read more: http://m.onkey.org/2008/11/10/rails-meets-sinatra

TODO feature the blog with cucumber
